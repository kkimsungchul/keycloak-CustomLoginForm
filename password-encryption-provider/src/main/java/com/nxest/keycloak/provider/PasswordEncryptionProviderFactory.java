 ...
 * @author l10178
 */
public class PasswordEncryptionProviderFactory implements AuthenticatorFactory {

    public static final String PROVIDER_ID = "custom password form";
    public static final UsernamePasswordForm SINGLETON = new PasswordEncryptionProvider();
